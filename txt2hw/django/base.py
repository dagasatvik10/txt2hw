...
from txt2hw.env import BASE_DIR, env
...
SECRET_KEY = "django-insecure-xdvp$s4y5_naz*)_^s)m(_6aqkve^*&2r48sl49hhw8f3m&hll"
...
LOCAL_APPS = [
    ...
    "characters.apps.CharacterConfig",
]
...
WSGI_APPLICATION = "txt2hw.wsgi.application"
